...
export default {
  ...
  async mounted() {
    ...
    this.roomFromDate.nickname = this.nickname
    try {
  ...
  methods: {
    ...
    sendChat(msg) {
      ...
      msg = new MessageModel(TYPE_COMMAND_CHAT, this.roomFromDate.roomId, this.nickname + ': ' + msg + '\n')
      this.wsSend(msg)
    },
    ...
    async initLocalWebsocket() {
      ...
      this.wsUrl = "ws:localhost:8080/jeecg-boot/ws/webrtc"
